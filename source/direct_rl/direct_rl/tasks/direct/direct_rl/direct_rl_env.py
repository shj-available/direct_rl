...
## define the Direct RL environment
class DirectRlEnv(DirectRLEnv):
    cfg: DirectRlEnvCfg
    ...
    def _setup_scene(self):
        ...
        # add lights        self.command_marker_orientations = math_utils.quat_from_angle_axis(self.yaws, self.up_dir)
    ...
    # step function pre-physics
    def _pre_physics_step(self, actions: torch.Tensor) -> None:
        self.actions = actions.clone()
        self._visualize_markers()

    # step function post-physics
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        out_of_bounds = torch.zeros_like(time_out, dtype=torch.bool)  # 没有终止条件时返回全 False
